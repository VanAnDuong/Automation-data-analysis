...
# Create a process query function
...
def main():
    ...
    st.set_page_config(page_title="Van An Analytics", page_icon="📊", layout="centered")
    st.header("Automation Data Analysis Tool")
    st.write(
        "### Welcome to my data analysis web. It can assist your daily data analysis tasks. Please enjoy !"
    )
